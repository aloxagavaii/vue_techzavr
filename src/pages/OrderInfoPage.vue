      ...
      <form class="cart__form form" action="#" method="POST">
        ...
        <div class="cart__block">
          <ul class="cart__orders">
            <li class="cart__order" v-for="or in order" :key="or.id">
              <h3>{{ or.product.title }}</h3>
              <b>{{ (or.product.price * or.quantity) | numberFormat }} ₽</b>
              <span>Артикул: {{ or.id }}</span>
            </li>
          </ul>

          <div class="cart__total">
            <p>Доставка: <b>500 ₽</b></p>
            <p>Итого: <b>{{ order.length }}</b>
...
export default {
  computed: {
    ...mapGetters({ order: 'orderInfoPagee' }),
  },
