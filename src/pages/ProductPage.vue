<template>
  ...
  <main class="content container" v-else-if="!productData">не удалось за...</main>
      ...
      <div class="item__info">
        ...
        <div class="item__form">
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <fieldset class="form__block">
              ...
              <ul class="sizes sizes--primery">
                <li class="sizes__item">
                  <label for="radio32" class="sizes__label">
                    <input id="radio32" class="sizes__radio sr-only" type="radio"
                ...
                <li class="sizes__item">
                  <label for="radio64" class="sizes__label">
                    <input id="radio64" class="sizes__radio sr-only" type="radio"
                ...
                <li class="sizes__item">
                  <label for="radio128" class="sizes__label">
                    <input id="radio128" class="sizes__radio sr-only" type="radio"
            ...
            <div v-show="productAdded">добавлен в корзину</div>
            <div v-show="productAddSending">идет добавление</div>
          </form>
        </div>
      </div>
              ...
              что не превышает габариты смартфона. Корпус гаджета выполнен
               из черного пластика. На обращенной к пользователю стороне расположен
                дисплей диагональю 56 мм. На дисплей выводятся координаты и скорость,
                 а также полученная со смартфона и синхронизированных датчиков
